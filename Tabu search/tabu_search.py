...
class TabuSearch(object):
    """
    Tabu search for scheduling unordered list of tasks.
    ...
    def optimize(self, tree, alternative, task_duration, release_dates, due_dates, no_iter, generate_initial_sol=True):
        """
        ...
        if not generate_initial_sol:
            ...
            self.current_solution = TabuSearch.generate_solution(tree, alternative, tasks_to_complete, task_duration)
        ...
        while iteration < no_iter:
            [neighborhood, neighborhood_move, total_tardiness] = self.generate_neighborhood(self.current_solution, sim,
                                                                                            tasks_to_complete,
            ...
            self.tabu_list.append([neighborhood_move[best_index][1], neighborhood_move[best_index][0]])
    ...
    def generate_solution(tree, alternative, tasks_to_complete, task_duration):
        ...
        base, _, _ = TabuSearch.create_feasible_base_order(alternative, [], tasks_to_complete, sim)
        sim.setup()

        [methods, base_index] = TabuSearch.create_solution_from_base(base, alternative)
    ...
    def generate_neighborhood(solution, sim, to_complete, due_dates, release_dates):
        ...
        return [neighborhood, moves, total_tardiness]
